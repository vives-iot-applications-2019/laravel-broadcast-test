...
console.log("hello");
window.Echo.channel('laravel_database_sayHello').listen('Hello', function (e) {
  console.log(e);
});
window.Echo.channel('sayHello').listen('test', function (e) {
  console.log(e);
});
...
__webpack_require__(/*! D:\VIVES\laravel-broadcast\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\VIVES\laravel-broadcast\resources\sass\app.scss */"./resources/sass/app.scss");
